...
"""Verify that starting dommecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dommecoin with -h for help text")
        ...
        self.log.info("Start dommecoin with -version for version information")
