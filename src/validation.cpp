...
#if defined(NDEBUG)
# error "Dommecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Dommecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DOM additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("dommecoin-scriptch");
