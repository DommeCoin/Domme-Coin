...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dommecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dommecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dommecoin transaction") + "\n" +
              "  dommecoin-tx [options] -create [commands]   " + _("Create hex-encoded dommecoin transaction") + "\n" +
              "\n";
